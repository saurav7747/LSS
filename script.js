...
(function initLoader() {
  ...
  // Inject text so CSS typing animation works on actual content
  loaderFull.textContent = text;

  // Total animation: ~0.8s type + 0.7s pause → fade at ~1.5s
  const FADE_DELAY = 1500; // ms before fade starts
